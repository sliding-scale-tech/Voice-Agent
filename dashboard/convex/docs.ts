...
const DEFAULT_DOCS: Array<{ title: string; body: string }> = [
  ...
  {
    title: "Support hours",
    body: "Our support team is available 9am to 5pm Monday through Friday, UK time. We are closed on public holidays.",
  },
];
 ...
 * this team already has any docs — never clobbers real work.
 *
